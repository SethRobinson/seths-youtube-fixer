// Test: Wipe -> in-page presets -> preset opens scan in a new tab; Info -> in-page
...
console.log(`WIPE: presets=${presetCount} | preset->newtab=${!!wipeTab} ${wipeTab ? new URL(wipeTab.url()).search : ''}`);
